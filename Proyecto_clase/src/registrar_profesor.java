...
public class registrar_profesor 
{
	...
	private ArrayList<String> datosProfesor = new ArrayList<>();
    ...
    public void profesor()
    {
        ...
        if (respuesta.equalsIgnoreCase("si")) 
        {
            ...
            //no tocar el this, sujeta todo el programa

            // Guardamos la información en el ArrayList
            datosProfesor.add(maestria1);
            datosProfesor.add(maestria2);
            datosProfesor.add(maestria3);
            datosProfesor.add(maestria4);
            datosProfesor.add(""); // hueco para la contraseña
            ...
            datosProfesor.set(4, scanner.nextLine());
            boolean contraseñaCorrecta = false;
            
            while(!contraseñaCorrecta)
            {
                if (datosProfesor.get(4) == null || datosProfesor.get(4).equals("")) 
                {
